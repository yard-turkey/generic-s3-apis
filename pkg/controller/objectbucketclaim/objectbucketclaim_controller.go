...
import (
	...
	storeoperatorv1alpha1 "github.com/yard-turkey/generic-s3-bucket-apis/pkg/apis/storeoperator.io/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &storeoperatorv1alpha1.ObjectBucketClaim{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &storeoperatorv1alpha1.ObjectBucketClaim{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileObjectBucketClaim) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &storeoperatorv1alpha1.ObjectBucketClaim{}
...
func newPodForCR(cr *storeoperatorv1alpha1.ObjectBucketClaim) *corev1.Pod {
